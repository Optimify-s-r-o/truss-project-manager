...
const dictionary: Lang = {
	...
	common: {
		...
		ok: "Ok",
		jobClipboardSuccess: 'Odkaz pro stažení souboru zkopírován. Odkaz bude platný po dobu jednoho týdne.',
		jobClipboard: 'Kopírovat odkaz Truss souboru pro sdílení',
