...
const dictionary: Lang = {
  ...
  remove: {
    ...
    bin:
      'Opravdu chcete vysypat koš? Data budou permanetně smazána.' +
  ...
  common: {
    ...
    ok: 'Ok',
    jobClipboardSuccess: "Odkaz zkopírován do schránky. Platnost odkazu je 7 dní.",
    ...
    dislaimerParagraph1:
      'Truss Project Manager je cloudová aplikace, která data ukládá ve Fine cloudu hostovaném na Amazon Web Services na území Evropské unie.',
    dislaimerParagraph2: 'Amazon Web Services zajišťuje:',
    dislaimerParagraph3:
      'Přes veškerou snahu a péči firma FINE nemůže nést a nenese odpovědnost za ztrátu, zcizení nebo nedostupnost dat – přestože takovou událost považuje za velmi nepravděpodobnou. Nejsme schopni zamezit zásahům vyšší moci, válečným konfliktům, hackerským útokům a dalším nečekaným událostem mimo naši kontrolu. Z toho důvodu doporučujeme provádět pravidelné zálohy pomocí k tomu určeného nástroje dostupného v aplikaci Truss Project Manager.',
    disclaimerList1:
      '- vysokou dostupnost služby, abyste nebyli omezováni při práci s aplikací',
    disclaimerList2:
      '- řízený přístup k datům, aby se k datům aplikace nedostala žádná neoprávněná osoba',
    disclaimerList3:
      '- okamžitou automatickou replikaci dat do více lokalit, aby se zamezilo jejich ztrátě či poškození',
    theme: 'Změna barvy',
    thickness: 'Tloušťka',
  ...
  settings: {
    ...
    backup: 'Záloha',
    backupProgress: 'Stahuji projekt {{projectName}} ({{index}} z {{total}})',
  ...
  backup: {
    description:
      'Zálohujte si všechny soubory z Truss Project Manageru.  Soubory budou staženy do složky: {{directory}}',
    alert:
      'UPOZORNĚNÍ: Pokud existuje stará záloha, bude touto akcí přepsána. Během zálohy nevypínejte program ani neopouštějte tuto stránku. V závislosti na množství dat může operace trvat delší dobu.',
