...
const dictionary: Lang = {
  ...
  settings: {
    ...
    backup: 'Backup',
    backupProgress: 'Downloading project {{projectName}} ({{index}}/{{total}})',
  ...
  backup: {
    description:
      'Back up all your files from Truss Project Manager. The files will be downloaded to the {{directory}} folder',
    alert:
      'NOTE: If an old backup exists, it will be overwritten by this action. Do not turn off the program or leave this page during the backup. Depending on the amount of data, the operation may take longer.',
